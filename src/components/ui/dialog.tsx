"use client";
/**
 * Dialog — lightweight, dependency-free modal.
 * Handles Escape-to-close, backdrop click, body scroll lock, and focus return.
 * Used for create/edit task and delete confirmations.
 */
